...
export default function SignUp() {
  ...
  const createUser = (e) => {
    ...
    const usrName = e.target.usrName.value;
    ...
    if (/.{6,}/.test(password)) {
      fetch("http://localhost:3000/api/createUser", {
        ...
        .then((data) => {
          if (data.message === "User created successfully.") {
            ...
            if (e.target.usrName.classList.contains("text-red-400")) {
              e.target.usrName.classList.toggle("text-red-400");
            }
          } else if (data.message === "* Username is already in use.") {
            if (!e.target.usrName.classList.contains("text-red-400")) {
              setError(data.message);
              e.target.usrName.classList.toggle("text-red-400");
              e.target.usrName.focus();
            }
      ...
      if (e.target.password.classList.contains("text-red-400")) {
        e.target.password.classList.remove("text-red-400");
      } else {
        return;
      }
      ...
      e.target.password.classList.add("text-red-400");
      setError("* Use at least 6 or more character.");
    }
  };
          ...
          <div>
            ...
            <div className="sign-up-form-container">
              <form onSubmit={createUser}>
                ...
                <article>
                  <button type="submit" className="create-account-btn btn">
